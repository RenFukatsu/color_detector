...
class PointCloudColorDetector {
 public:
    PointCloudColorDetector(ros::NodeHandle nh = ros::NodeHandle(),
                            ros::NodeHandle private_nh = ros::NodeHandle("~"));
    void set_hsv_params();
    void set_color_enable_param();
    bool enable_color(color_detector_srvs::ColorEnable::Request &req,
                      color_detector_srvs::ColorEnable::Response &res);
    void sensor_callback(const sensor_msgs::PointCloud2ConstPtr &received_pc);
    void mask_point_cloud(const ThresholdHSV &thres_hsv,
    ...
    void publish_points(const pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr &pc,
    ...
    void get_target_cluster(const pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr &pc,
                            ...
                            const pcl::PointCloud<pcl::PointXYZRGB>::Ptr &output);
    color_detector_msgs::TargetPosition calc_target_position(
